...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--newton_muon_lr_factor", default=1.0, type=float)
    parser.add_argument("--newton_muon_ewma_beta", default=0.95, type=float)
    parser.add_argument("--newton_muon_ridge", default=0.2, type=float)
    parser.add_argument("--newton_muon_refresh_interval", default=32, type=int)
    parser.add_argument("--newton_muon_second_moment_init", default=1.0, type=float)
    parser.add_argument("--newton_muon_max_precond_dim", default=1024, type=int)
